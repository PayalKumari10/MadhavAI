...
describe('CropRecommender', () => {
  ...
  // Note: Tests for private methods (calculateSuitability, cropDatabase) have been removed
  // as they should not be tested directly. These are tested indirectly through public methods.
});
